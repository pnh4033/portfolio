  ...
  <div id="wrap">
    ...
    <table class="table table-hover" id="list_table">
      ...
      <tr>
  		...
  		<a href="/modifyProduct?pno=${list.pno}">&nbsp;&nbsp;
  		...
  		<a href="/removeProduct?pno=${list.pno}">
...
<!-- 새창으로 값 전달 -->
  <form name="removeForm" id="remove_form" action="/removeProduct" target="removeWindow" method="get">
...
$(".btn.btn-warning").click(function(event) {
	...
	var w=window.open("/removeProduct?pno="+pno, "removeWindow", 'top='+yloc+', left='+xloc+', toolbar=no, location=no, status=no, menubar=no, resizable=no, directories=no, width='+winWid+', height='+winHei);
