...
<br/><br/>
  ...
  <div class="row">
    ...
    <table class="table table-hover">
      <tr><td>
        <img src="/listImgsPno?pno=${productVO.pno}" id="sample"/>
      </tr></td>
...
$(document).ready(function() {
  ...
  $.getJSON("/listImgsString/"+pno, function(list) {   /* pno 에 해당하는 attach 된 이미지들 로드 */ 
     	...
     	$(list).each(function() {
	    	...
	    	str="<div>"
	    	+ "<img src='/listImgs?fileName="+fileName+"'/>"
	    	+"</div>"; 
...
$("#btnDirect").click(function(e) {
	...
	window.location.replace("/pay?userID="+userID+"&pno="+pno);
