  ...
  <div id="center">  
	...
	<div id="body">
	  ...
	  <div>
	    ...
	    <form name="form1" id="formUser" action="/myPage" method="post">
...
<div class="list_div">
  <ul class="list_ul">
    ...
    <li class="list_li1">
    <a href="/readProduct${paging.makeSearchQuery(paging.criteria.page)}&pno=${vo.pno}" class="listItem">
    <img src="/listImgsPno?pno=${vo.pno}" id="listImg"/></a></li>
...
<div id="pagingDiv">      <!-- 페이징 처리 -->
  <ul id="paging">
    ...
    <c:if test="${paging.prev}">
      <li id="search_pageLi"><a href="index${paging.makeSearchQuery(paging.startPage-1)}"
    ...
    <c:if test="${paging.next && paging.endPage > 0 }">
      <li id="search_pageLi"><a href="index${paging.makeSearchQuery(paging.endPage+1)}" 
