package web.portfolio.IamportRestHttpClientJava;
...
import web.portfolio.IamportRestHttpClientJava.request.AuthData;
import web.portfolio.IamportRestHttpClientJava.request.CancelData;
import web.portfolio.IamportRestHttpClientJava.response.AccessToken;
import web.portfolio.IamportRestHttpClientJava.response.IamportResponse;
import web.portfolio.IamportRestHttpClientJava.response.Payment;
...
//	private static final String API_URL = "https://api.iamport.kr";
	...
	private IamportResponse<AccessToken> getAuth() throws Exception{
		...
		try {
			...
			ResponseHandler handler = (ResponseHandler) new BasicResponseHandler();
			String body = ((BasicResponseHandler) handler).handleResponse(response);
